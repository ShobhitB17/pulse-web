...
const styles = {
  ...
  statCard: { backgroundColor: '#1a1a1a', border: '1px solid #2e2e2e', borderRadius: '10px', padding: '20px 28px', flex: 1, textAlign: 'center' },
  ...
  timeOfDayGrid: { display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '12px' },
